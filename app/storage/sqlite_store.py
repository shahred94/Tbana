"""SQLite storage for LiveTrigger."""
...
def update_gift_status(
    ...
    """Backward compatibility for old gift system."""
...
def import_configuration(
    ...
    if (
        application
        and application != "LiveTrigger"
    ):

        raise ValueError(
            "This is not a LiveTrigger configuration file."
        )
