...
function goalSettings() {
    ...
    return {
        title: params.get("title") || "Random Traffic",
        label: params.get("label") || "Likes",
        target,
        start,
    };
}
...
function handleGoalMessage(data) {
