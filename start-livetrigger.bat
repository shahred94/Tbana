...
if not exist ".venv\Scripts\python.exe" (
    echo [FAILED] LiveTrigger has not been installed yet.
    echo.
...
if errorlevel 1 (
    echo [FAILED] LiveTrigger's private Python environment is broken or unsupported.
    echo.
...
echo.
echo Keep this window open while using LiveTrigger.
...
if not "%SERVER_EXIT%"=="0" (
    echo.
    echo ==========================================
    echo [FAILED] LiveTrigger stopped with an error.
    echo ==========================================
    echo.
