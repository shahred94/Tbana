...
cd /d "%~dp0"
title LiveTrigger Installer

echo.
echo ==========================================
echo          LiveTrigger Installer
echo ==========================================
...
if not defined PYTHON_EXE (
    ...
    echo [INFO] LiveTrigger will now download and install Python 3.13.
...
if not defined PYTHON_EXE (
    ...
    echo.
    echo LiveTrigger requires Python 3.10, 3.11, 3.12, or 3.13.
...
if not exist ".venv\Scripts\python.exe" (
    echo [1/3] Creating the private LiveTrigger environment...
...
if errorlevel 1 (
    set "FAILED_STEP=Could not upgrade pip. Check your internet connection."
    goto :failed
)

echo.
echo [3/3] Installing LiveTrigger dependencies...
...
echo.
echo ==========================================
echo [SUCCESS] LiveTrigger is ready to use.
echo ==========================================
echo.
echo Next: Double-click start-livetrigger.bat
echo.
pause
exit /b 0
...
echo.
echo ==========================================
echo [FAILED] LiveTrigger installation failed.
echo ==========================================
